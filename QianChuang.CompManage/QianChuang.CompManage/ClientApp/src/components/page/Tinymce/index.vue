...
import { Component, Prop, Vue, Watch,Inject,Ref } from "vue-property-decorator";
...
export default class extends Vue {
  ...
  @Prop({ required: false }) private isShow!: boolean;
  ...
  @Prop({ default: "660px" }) private height!: string | number;
  ...
  get initOptions() {
    return {
      ...
      language_url:
        this.language === "en"
          ? ""
          : `static/tinymce/langs/${this.language}.js`,
      skin_url: `https://lib.baomitu.com/tinymce/5.7.0/skins/ui/oxide/`,
      emoticons_database_url: `static/tinymce/emojis.min.js`,
      ...
      setup: (editor: any) => {
        ...
        editor.on("Init", (e: any) => {
          var bgObj=document.getElementsByClassName("tox-tinymce-aux")[0];
  ...
  private onShow() {
    ...
    debugger
    tinymceInstance.setContent(this.value);
  }
